...
import { Card, Box, HStack, Input, Button, useNumberInput, Stack, CardBody, Slider, Image, Icon } from '@chakra-ui/react';
...
const Details = () => {
    ...
    const { pizzaname, descriptions, img, img2, img3, price } = infoPiza ?? {}
